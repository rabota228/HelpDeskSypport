...
export function ChatArea({ chatId }: { chatId?: number }) {
  ...
  return (
    <div className="flex flex-col h-full bg-background relative selection:bg-primary/30">
      ...
      <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-background via-background/95 to-transparent pb-6 pt-16 px-4 md:px-8 border-none pointer-events-none">
        <div className="max-w-4xl mx-auto relative group pointer-events-auto">
          ...
          {/* Input Box */}
          <div className="relative flex items-end gap-2 bg-card border-2 border-border/60 focus-within:border-primary/50 rounded-2xl p-2 shadow-2xl transition-all duration-300">
            <textarea 
              ref={textareaRef}
              value={input}
              ...
              className="w-full bg-transparent resize-none p-3 max-h-48 focus:outline-none text-foreground placeholder:text-muted-foreground font-medium"
              rows={1}
            ...
            <button 
              ...
              className={cn(
                "p-3.5 rounded-xl font-semibold transition-all duration-300 shrink-0 shadow-lg",
          ...
          <div className="text-center mt-3 text-xs font-mono text-muted-foreground/60">
