  ...
  return (
    <div className="flex h-screen w-full bg-background overflow-hidden selection:bg-primary/30 text-foreground">
      ...
      <main className="flex-1 flex flex-col min-w-0 relative h-full">
        ...
        <div className="md:hidden flex items-center justify-between p-4 border-b border-border bg-card/80 backdrop-blur-md z-10 shrink-0 shadow-sm">
          <button 
          ...
          <div className="flex items-center gap-2">
            <span className="font-display font-bold tracking-tight">HelpDesk Pro</span>
          </div>
